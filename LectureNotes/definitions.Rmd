...
The cost function is a fancy form of an average aimed at showing how well the hypothesis function performed over the supervised outcome test data.  the cost is equal to $\frac{1}{2} \bar{x}$ where $\bar{x} = (h(x^{i}) - y^{i})^{2}$ defined as the mean of the squares difference of the predicted function $h$ and the response y defined as the mean of the squares difference of the predicted function $h$ and the response y.
